...
use
  Zynga\Framework\Service\V1\Exceptions\InvalidServiceResponse as InvalidServiceResponseException
;
use Zynga\Framework\Service\V1\Interfaces\ClientInterface;
