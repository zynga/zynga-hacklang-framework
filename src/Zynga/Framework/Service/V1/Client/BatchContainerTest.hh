...
use Zynga\Framework\Service\V1\Client;
use Zynga\Framework\Service\V1\Client\BatchContainer;
use Zynga\Framework\Service\V1\Client\Mock\Batch as MockBatch;
use Zynga\Framework\Service\V1\Client\Mock\BatchIsStartedBatch;
use Zynga\Framework\Service\V1\Client\Mock\FailedBatch;
use Zynga\Framework\Service\V1\Client\Mock\BatchContainer as MockBatchContainer;
use Zynga\Framework\Service\V1\Exceptions\BatchAlreadyStartedException;
use Zynga\Framework\Service\V1\Exceptions\BatchFailed as BatchFailedException;
use Zynga\Framework\Service\V1\Exceptions\BatchNotStartedException;
use Zynga\Framework\Service\V1\Test\RequestNoRequired;
use Zynga\Framework\Testing\TestCase\V2\Base as TestCase;
use Zynga\Framework\Service\V1\Test\Router\Services\Mock\V1\Response as MockResponse;
...
class BatchContainerTest extends TestCase {
  ...
  /**
   * @expectedException Zynga\Framework\Service\V1\Exceptions\UnknownBatchException
   */
