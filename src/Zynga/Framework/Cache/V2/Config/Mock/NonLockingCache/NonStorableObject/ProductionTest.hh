...
namespace Zynga\Framework\Cache\V2\Config\Mock\NonLockingCache\NonStorableObject;

use Zynga\Framework\Testing\TestCase\V2\Base as TestCase;

use
  Zynga\Framework\Cache\V2\Config\Mock\NonLockingCache\NonStorableObject\Production as ConfigUnderTest
;
